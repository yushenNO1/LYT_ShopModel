...
+ (UIColor *)AppColor {
    return [UIColor colorWithRed:9/255.0 green:19/255.0 blue:35/255.0 alpha:1.0];
}
...
+ (UIColor *)anniuColor{
    return [UIColor colorWithRed:215/255.0 green:55/255.0 blue:55/255.0 alpha:1];
}
+ (UIColor *)zitiColor{
    return [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];
}
+ (UIColor *)biaotiColor{
    return [UIColor colorWithRed:37/255.0 green:40/255.0 blue:37/255.0 alpha:1];
}
...
+ (UIColor *)lineColor{
    return [UIColor colorWithRed:216/255.0 green:216/255.0 blue:216/255.0 alpha:1];
}
