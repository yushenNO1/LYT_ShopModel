...
#define PAYMENT_WIDTH [UIScreen mainScreen].bounds.size.width-300
#define PWD_COUNT 6
#define DOT_WIDTH 10
#define KEYBOARD_HEIGHT 180
#define KEY_VIEW_DISTANCE 0
...
- (void)drawView {
    if (!_paymentAlert) {
        _paymentAlert = [[UIView alloc]initWithFrame:CGRectMake(150, [UIScreen mainScreen].bounds.size.height-KEYBOARD_HEIGHT-KEY_VIEW_DISTANCE-ALERT_HEIGHT, [UIScreen mainScreen].bounds.size.width-300, ALERT_HEIGHT)];
        ...
        [_closeBtn addTarget:self action:@selector(dissMissCancel) forControlEvents:UIControlEventTouchUpInside];
